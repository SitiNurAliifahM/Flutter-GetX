  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      backgroundColor: HexColor(
          '#feeee8'), // Menentukan warna latar belakang Scaffold dengan kode warna heksadesimal
      body: Center(
        ...
        child: Column(
          ...
          children: [
            ...
            Lottie.network(
              // Widget Lottie untuk menampilkan animasi Lottie dengan sumber dari internet
